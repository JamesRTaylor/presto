...
public class ParquetMetaDataUtilsTest
{
    ...
    public void testGetParquetMetadataEncrypted() throws IOException
    {
        ...
        FileDecryptionProperties fileDecryptionProperties = FileDecryptionProperties.builder().build();
        MetadataReader reader = new MetadataReader();
        ParquetMetadata parquetMetadata = reader.getParquetMetadata(inputStream, new ParquetDataSourceId("ID"), fileSize, false, fileDecryptionProperties).getParquetMetadata();

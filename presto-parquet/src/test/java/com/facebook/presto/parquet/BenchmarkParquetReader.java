...
public class BenchmarkParquetReader
{
    ...
    private abstract static class BenchmarkData
    {
                ...
                throws IOException
        {
            ...
            ParquetMetadata parquetMetadata = MetadataReader.readFooter(FileSystem.getLocal(new Configuration()), new Path(file.getAbsolutePath()), file.length(), null).getParquetMetadata();

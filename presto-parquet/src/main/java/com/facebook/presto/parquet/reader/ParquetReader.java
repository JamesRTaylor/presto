        ...
        implements Closeable
{
            ...
            throws IOException
    {
        if (!isEncryptedColumn(fileDecryptor, columnDescriptor)) {
            return columnChunk.readAllPages(null, null, null, -1, -1);
        }
        else {
            ...
            return columnChunk.readAllPages(colDecSetup.getMetaDataDecryptor(), colDecSetup.getDataDecryptor(), fileDecryptor.getFileAAD(), currentBlock, colDecSetup.getOrdinal());
        }
    }
